...
INSERT INTO people (name) VALUES ('Bartholomew J Simpson');
SELECT name from people;
...
SELECT * from movies WHERE title = 'Iron Man' OR title = 'Iron Man 2' OR title = 'Iron Man 3';

-- Extension - Research how to delete multiple entries from your table in a single command.
-- DELETE FROM thetablename WHERE cellvalue = something;
-- or different way including further logic
-- DELETE FROM thetablename WHERE (Name = 'Name1' AND Location = 'Location1') OR (Name = 'Name2' AND Location = 'Location2') OR (Name = 'Name3' AND Location = 'Location3');
